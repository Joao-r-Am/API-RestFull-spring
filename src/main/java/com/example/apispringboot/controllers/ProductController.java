...
import com.example.apispringboot.dtos.ProductRecordDto;
import com.example.apispringboot.models.ProductsModel;
...
public class ProductController {
    ...
    public ResponseEntity<Object> getOneProduct(@PathVariable(value = "id")UUID id){
        ...
        if(product0.isEmpty()){
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body("Product not found! ☢️❌🅰️");
        }
    ...
    public ResponseEntity<Object> deleteProduct(@PathVariable(value = "id") UUID id) {
        ...
        return ResponseEntity.status(HttpStatus.OK).body("TCHAU BRIGADO!!!");
    }
}
